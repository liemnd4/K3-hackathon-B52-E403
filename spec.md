...
**Golden set:** 20 case lưu tại `eval/golden-set.json` — cấu trúc: ≥2 case/lớp (4 lớp), 8-10 case thường, 2-4 case hiếm, ≥10 case lấy từ chatlog thật (VD: message_id M0780, M0949).
